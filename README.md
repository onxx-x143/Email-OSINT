...
**EmailOSINTl** is a professional-grade OSINT (Open Source Intelligence) tool designed for advanced email address extraction through comprehensive web crawling. Built for cybersecurity professionals, penetration testers, and intelligence analysts.
...
**What Does EmailOSINTl Do?**

**EmailOSINTl** systematically crawls target websites to:
...
## Termux install 
```
git clone https://github.com/onxx-x143/Email-OSINT.git
cd Email-OSINT
chmod +x main.sh
bash main.sh
```
...
• Basic email extraction
    ...
    python3 onxx.py https://target-company.com

• With SSL verification disabled (for testing only)

    python3 onxx.py https://example.com --no-verify-ssl

• Deep crawl with custom limits

    python3 onxx.py https://target-company.com --max-pages 500 --max-depth 4

• With proxy for anonymity

    python3 onxx.py https://target-company.com --proxy socks5://127.0.0.1:9050

• Custom output location

    python3 onxx.py https://target-company.com --output ./intel/results.json

• Faster crawling with reduced delay

    python3 onxx.py https://target-company.com --delay 0.5

• Professional table formatting

    python3 onxx.py https://target-company.com --table-format fancy_grid
...
• Phase 1: Initial Recon
    ...
    python3 onxx.py https://target.com --max-pages 100 --max-depth 2

• Phase 2: Deep Analysis

    python3 onxx.py https://target.com/blog --max-pages 300 --max-depth 3

• Phase 3: Focused Extraction

    python3 onxx.py https://target.com/about/team --max-pages 50
